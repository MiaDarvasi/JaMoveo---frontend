...
window.socketService = socketService // For dev debugging
...
function createSocketService() {
  ...
  const socketService = {
    ...
    // ✅ New functions for live session management
    ...
    // Existing function for watching users
    userWatch(userId) {
